...
public class MainActivity extends AppCompatActivity implements OnDateSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        oneDayDecorator = new OneDayDecorator(MainActivity.this);
    ...
    public void onDateSelected(@NonNull MaterialCalendarView widget, @NonNull CalendarDay date, boolean selected) {
        ...
        if(events.shouldDecorate(date)) {
            ...
            eventListView.setAdapter(new EventAdapter(MainActivity.this, events));
            eventListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> parent, View view,
                                        int position, long id) {
                    Event e = selectedEvents.get(position);
                    Intent newsScreen = new Intent(MainActivity.this, EventActivity.class);
    ...
    private class GetXML extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                URL url = new URL("https://computingsystems.me/etcapp/events/events.xml");
        ...
        protected void onPostExecute(String result) {
            ...
            events = new EventDecorator(Color.BLUE, dates);
